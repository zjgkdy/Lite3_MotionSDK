                                 ...
                                 RobotData &data)
{
  ...
  else
  {
    ...
    cmd.joint_cmd[3 * leg_side].torque = 60 * (goal_angle[0] - data.joint_data.joint_data[3 * leg_side].position) + 0.7 * (goal_velocity[0] - data.joint_data.joint_data[3 * leg_side].velocity);
    cmd.joint_cmd[3 * leg_side + 1].torque = 80 * (goal_angle[1] - data.joint_data.joint_data[3 * leg_side + 1].position) + 0.7 * (goal_velocity[1] - data.joint_data.joint_data[3 * leg_side + 1].velocity);
    cmd.joint_cmd[3 * leg_side + 2].torque = 80 * (goal_angle[2] - data.joint_data.joint_data[3 * leg_side + 2].position) + 0.7 * (goal_velocity[2] - data.joint_data.joint_data[3 * leg_side + 2].velocity);
  }
}
